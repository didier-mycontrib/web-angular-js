...
myRestServices.factory('Compte', ['$resource',
		...
		return $resource('http://localhost:8080/minibank2015-web/pages/services/rest/json/gestioncomptes/comptes/:idRes' /*default url*/, {  idRes:'@numero' } /*default params */, {		
			       doVirement : { url : 'http://localhost:8080/minibank2015-web/pages/services/rest/json/gestioncomptes/virement' /*redifined url */, method:'POST'},
			       dernieresOperations : { url : 'http://localhost:8080/minibank2015-web/pages/services/rest/json/gestioncomptes/dernieresOperations' /*redifined url */, method:'GET', isArray:true},
	           });
	       }   
]);
...
myRestServices.factory('Transfert', ['$resource',
          ...
          return $resource('http://localhost:8080/minibank2015-web/pages/services/rest/json/gestioncomptes/virement:idRes' /*default url*/, {  } /*default params */, {		
...
myRestServices.factory('Client', ['$resource',
                          		...
                          		return $resource('http://localhost:8080/minibank2015-web/pages/services/rest/json/gestionclients/clients/:idRes' /*default url*/, {  idRes:'@numero' } /*default params */, {		
                          			verifyAuth : { url : 'http://localhost:8080/minibank2015-web/pages/services/rest/json/gestionclients/verifyAuth' /*redifined url */, method:'POST'}
                          	           });
                          	       }   
                          ]);
